    ...
    <v-hover>
      <template v-slot:default="{ hover }">
        ...
        >
          ...
          <v-card-text>
            我们是成立{{ existYear }}年的学生组织，历经变迁，现隶属于信息中心，
            参与校内网络基础设施维护工作，提供开源软件镜像等诸多服务。
          </v-card-text>
          <v-card-title> ## 我们要做的事 </v-card-title>
          <v-card-text>
            1. 向校内外提供开源软件镜像、在线文档、IP 电视等服务；<br />
            2. 维护两校区学生宿舍区的网络基础设施。
          </v-card-text>
          ...
          <v-card-title> ## 招新方向 </v-card-title>
          <v-card-text>
            <p>
              我们面向<strong>电子科技大学的全体学生</strong>招新，包括以下四个方向：
            </p>
